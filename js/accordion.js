"strict";
const accordion = document.querySelectorAll(".accord-content");
const faqItem = document.querySelectorAll(".faq-container");

playAction(accordion, ".arrow", ".accorddion", ".accord-item");
...
playAction(faqItem, ".angle", ".faq-box", ".faq-item");
